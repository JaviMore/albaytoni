    ...
    <div className="bg-cream text-brand-dark font-serif min-h-screen">
      ...
      <main className="overflow-x-hidden">
        ...
        <section className="text-center py-25 px-4 text-center">
          ...
          <p className="font-bold text-brand-red text-xl">ENS CASEM!!!</p>
          <div className="flex justify-center items-center">
         
              <img src="assets/main_photo.jpg" alt="Alba and Toni" className="rounded-lg shadow-lg w-full max-w-lg" />
             
          </div>
          <p className="font-bold text-brand-red text-xl">SI! SI! NOSALTRES</p>
        ...
        <section className="pb-20 px-4 text-center">
          <p className="text-xl">Esta invitación es para</p>
          ...
          <a href="#" target="_blank" rel="noopener noreferrer" className="inline-block bg-brand-green text-cream font-seriff font-bold py-3 px-12 rounded-md mt-8 hover:bg-opacity-90 transition-colors tracking-wider">
            FORMULARIO
          </a>
        </section>
        ...
        <section className="bg-brand-green text-cream py-20 px-4">
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 text-center">
            ...
            <div>
              ...
              <img src="assets/trumpet_illustration.png" alt="Música" className="w-48 h-48 mx-auto my-4" />
              <p className="font-seriff font-bold text-2xl">¿NOS AYUDAS CON LA PLAYLIST?</p>
